...
x2INT = [0,5];
INT = [x1INT , x2INT];
fig_given = figure('Name',"GivenInfo_5.2",'NumberTitle','off');
...
c1.LineWidth = 2;
c2.LineWidth = 2;
saveas(fig_given, 'HW5-2_contour_noFILL.png');
c1.Fill = 'on';
c2.Fill = "on";
saveas(fig_given, 'HW5-2_contour_FILLon.png');
% close(1)