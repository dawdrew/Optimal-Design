...
x2INT = [0,5];
INT = [x1INT , x2INT];
fig_given = figure('Name',"GivenInfo_5.5",'NumberTitle','off');
...
c2.LineWidth = 2;
c3.LineWidth = 2;
saveas(fig_given, 'HW5-5_contour_noFILL.png');
c1.Fill = 'on';
c2.Fill = "on";
c3.Fill = "on";
saveas(fig_given, 'HW5-5_contour_FILLon.png');
% close(1)